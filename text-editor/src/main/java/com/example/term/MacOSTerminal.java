...
public class MacOSTerminal implements Terminal {
  ...
  public WindowSize getWindowSize() {
    ...
    final int rc = MacOSTerminal.LibC.INSTANCE.ioctl(MacOSTerminal.LibC.SYSTEM_OUT_FD, LibC.TIOCGWINSZ, winsize);
  ...
  interface LibC extends Library {
    ...
    int ioctl(int fd, int opt, MacOSTerminal.LibC.Winsize winsize);
